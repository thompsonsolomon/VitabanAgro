...
export const product = [
  ...
  },
  {
    ...
    name: "BANGA SPICE",
    price: [
      { currency: "USD", value: 10, sign: "$" },
      { currency: "NGN", value: 100, sign: "#" },
      { currency: "EUR", value: 0.1, sign: "&" },
    ],
    qty: 1,
    category: "baby care",
    cover: Product6,
  ...
  },
  {
    ...
    category: "baby care",
    cover: Product7,
    desc: "Beans flour is a nutritious and versatile ingredient that is made from dried beans that have been ground into a fine powder, we produce the best and chemical-free beans flour, which is rich in protein, fiber, vitamins, and minerals, making it a great addition to a healthy diet, It is a particularly good source of plant-based protein, which is important for vegetarians and vegans who may not consume meat or other animal products.",
  },
  {
    id: 7,
    ...
    category: "farm",
    cover: Product8,
    desc: "Cameroon Pepper is native to west Africa and its known for its distinctive flavor and spiciness, and is used in a wide range of dishes, from soups and stews to marinades and sauces. Our Cameroon pepper is grown in our farms in some countries in West Africa and it is valued for its unique flavor. It has a slightly fruity taste that is complemented by a smoky, earthy undertone. This flavor makes it a popular ingredient in many West African dishes, including jollof rice, suya (grilled meat), and egusi soup.",
  },
  {
    id: 8,
    name: "CHARCOAL",
    ...
    category: "farm",
    cover: Product9,
    desc: "Charcoal is a black, porous substance that is made by burning wood or other organic materials in the absence of air. It has been used for centuries as a fuel source for cooking, heating, and lighting, and is still widely used today in many parts of the world. One of advantages of charcoal over other fuel sources. It is easy to transport and store, and is generally less expensive than other fuels such as propane or natural gas. Charcoal is also a sustainable resource, as it can be made from waste materials such as sawdust or agricultural residues.",
  },
  {
    id: 9,
